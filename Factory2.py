...
OS = []
MS = []
JS, MF = Generate_initial_solution(1)
k = 0
for i in JS:  # 1 [1,3]
    for a in range(2):
...
MS_P1=MS1
MS_P2=MS2
print("OS_P1 =>",OS_P1,"OS_P2 =>",OS_P2)
print("MS_P1 =>",MS_P1,"MS_P2 =>",MS_P2)

# lap de temps  J1(o1(M1,M2,M3),o2....)
# P1=population1 P2=population2
##OS_P1 = [1, 1, 2, 2, 3, 3]
##OS_P2 = [2, 3, 1, 3, 1, 2]  #J1(o11,o12)
##MS_P1 = [2, 1, 3, 1, 2, 2]
##MS_P2 = [1, 3, 2, 3, 3, 1] #chaque machine peut executer 2 opérations"""
